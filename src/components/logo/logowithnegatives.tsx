...
type LogoWithNegativesProps = {
  ...
  inverted?: boolean;
  onSymbolMouseOver?: (pos: number, symbol: string) => void;
  onSymbolMouseOut?: (pos: number, symbol: string) => void;
  onSymbolClick?: (pos: number, symbol: string) => void;
};
 ...
 */
export const LogoWithNegatives = ({
  values,
  height,
  width,
  alphabet,
